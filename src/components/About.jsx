                    ...
                    <RevealOnScroll>
                        <div>
                            ...
                            <p style={{ marginBottom: '1.5rem', color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                I am an innovative Full Stack Developer currently pursuing an <strong style={{ color: 'var(--text-primary)' }}>MSc in Computer Engineering</strong> with a focus on Data Analysis, Data Visualization, Machine Learning, Deep Learning and Artificial Intelligence.
                            ...
                            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: '1.8' }}>
                                My passion lies in bridging the gap between complex backend systems and intuitive frontend experiences, leveraging modern technologies like Java Spring Boot, React.js, Vue.js, Next.js and Python.
                            </p>
                        </div>
                    </RevealOnScroll>
                            ...
                            <div className="glass-panel" style={{
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                    <div>
                                        ...
                                        <p style={{ fontSize: '0.9rem', marginTop: '0.75rem', color: 'var(--text-tertiary)' }}>Grad Project: AI Based Sign Language Recognition App</p>
                                    </div>
